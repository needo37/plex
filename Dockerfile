...
RUN wget -P /tmp http://downloads.plexapp.com/plex-media-server/0.9.9.16.555-50cd0c3/plexmediaserver_0.9.9.16.555-50cd0c3_amd64.deb
RUN gdebi -n /tmp/plexmediaserver_0.9.9.16.555-50cd0c3_amd64.deb
RUN echo plexmediaserver_0.9.9.16.555-50cd0c3_amd64.deb | awk -F_ '{print $2}' > /tmp/version
RUN rm -f /tmp/plexmediaserver_0.9.9.16.555-50cd0c3_amd64.deb
