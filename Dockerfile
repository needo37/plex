...
RUN wget -P /tmp http://nightlies.plexapp.com/directdl/plex-media-server/dist-ninja/0.9.11.7.803-87d0708/plexmediaserver_0.9.11.7.803-87d0708_amd64.deb
RUN gdebi -n /tmp/plexmediaserver_0.9.11.7.803-87d0708_amd64.deb
RUN echo plexmediaserver_0.9.11.7.803-87d0708_amd64.deb | awk -F_ '{print $2}' > /tmp/version
RUN rm -f /tmp/plexmediaserver_0.9.11.7.803-87d0708_amd64.deb
